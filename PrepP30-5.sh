Opts="--DFA n12 --CCSD --Basis cc-pvdz --NIter 600 --a_Max 3.0 --eps_Cut 1.0"
...
echo '***************************************************************'
XOpts="--NIter 2000 --En 1e-5 --ForceCCSD --W_Cut 1.1 --a_Max 0.5 --EThermal 0.005"
for S in BH76_1_n2 G2RC_20_34 BH76_1_oh; do
    echo Special ${S}
    #./Invert-Lieb.py -M ./P30-5/${S}.mol ${Opts} ${XOpts}
done
echo '***************************************************************'
echo DOING ATOMS
echo '***************************************************************'
