Opts="--DFA pbe0 --CCSD --Basis cc-pvdz --NIter 600 --a_Max 3.0 --eps_Cut 0.5"

# Closed shells
echo '***************************************************************'
echo DOING CLOSED SHELLS
echo '***************************************************************'
for M in ALKBDE10_2_cao ALKBDE10_7_mgo BH76_1_n2 \
...
echo '***************************************************************'
for M in BH76_1_n2ohts BH76_1_oh BH76_9_hf2ts \
		       W4-11_114_c-hooo W4-11_120_t-hooo \
